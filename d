...
pee:AddButton({text = "discord.gg/N8nVyBcYBQ", flag = "sblasts", callback = function()
setclipboard("https://discord.gg/N8nVyBcYBQ")
  end})
...
game.StarterGui:SetCore("SendNotification",  {
 Title = "Aurora";
 Text = "Please only press one time or else!";
...
loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/solidestcrane7/Army/main/Aim%20bot"))()
